...
export function startScheduler() {
  ...
  console.log(
    "[Scheduler] Started: repayment audit, session token purge, orphaned record cleanup, KYC expiry reminder, escrow reconciliation, application SLA monitor, admin portfolio digest, suspicious activity scan, rate limit audit, deadlock detection, and analytics refresh jobs scheduled."
  );
}
